...
describe("Footer Links", () => {
  const linkChecker = [
    {
      user: userData.standardUser,
      linkUrls: linkUrls.Twitter,
      methodName: "socialTwitter",
    },
    {
      user: userData.standardUser,
      linkUrls: linkUrls.Facebook,
      methodName: "socialFacebook",
    },
    {
      user: userData.standardUser,
      linkUrls: linkUrls.LinkedIn,
      methodName: "socialLinkedIn",
    },
  ];
